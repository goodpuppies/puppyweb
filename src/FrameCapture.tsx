...
const SEND_FRAME_INTERVAL = 15; // 0 means send every frame, 1+ means send every Nth frame
const DOWNSAMPLE_FACTOR = 0.8; // Reduce resolution by this factor (0.5 = half width/height = 1/4 total pixels)
